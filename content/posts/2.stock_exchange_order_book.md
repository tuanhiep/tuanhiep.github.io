...
> **Next up**: In [Part 2](https://www.google.com/search?q=/posts/3.stock_exchange_matching_engine), we will breathe life into this static structure by building the **Matching Engine**. We will challenge the myth of multi-threading and explore the **LMAX Disruptor**.
