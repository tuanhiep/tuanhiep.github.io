...
*In a production environment, the idempotency replay path must verify that the existing reservation actually belongs to the same user, SKU, and shard. Existence alone is not enough if keys are ever derived incorrectly.*
