...
*In a real implementation, the reservation key (`res_key`) should be derived securely from the token and scoped to the SKU shard to prevent clients from choosing arbitrary Redis keys.*
