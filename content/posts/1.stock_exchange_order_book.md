...
> **Next up**: In [Part 2]({{< ref "3.stock_exchange_matching_engine.md" >}}), we will breathe life into this static structure by building the **Matching Engine**. We will challenge the myth of multi-threading and explore the **LMAX Disruptor**.
