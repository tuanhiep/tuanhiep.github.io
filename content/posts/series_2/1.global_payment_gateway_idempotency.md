...
## 🪞 Design Principle 1: The illusion of "exactly-once" delivery
...
## ⛩️ Design Principle 2: The anatomy of an idempotency key
...
### 🗝️ The "Brick" Summary (Mental model)
  ...
  * **🏛️ Invariant**: An operation applied multiple times must leave the system in the exact same state as if it were applied once.
...
> **Next up**: We have secured the entry point of the gateway. But what happens when a payment requires updating three different databases across three different microservices? In [Part 2]({{< ref "2.global_payment_gateway_sagas.md" >}}), we dive into the heart of distributed transactions: **2PC, Sagas, and Compensation Logic.**
