...
In [Part 1](/posts/1.stock_exchange_order_book), we built the **Order Book** in RAM.
In [Part 2](/posts/2.stock_exchange_matching_engine), we confined the **Matching Engine** to a single CPU core using the LMAX Disruptor.
...
> **Next up**: In the Grand Finale, [Part 4](/posts/4.stock_exchange_tradeoffs), we will tear this entire architecture down. We will discuss the ultimate trade-offs, when NOT to build this system, and the alternative architectures used by modern Tech Giants.
